...
import {
    AlignCenter, AlignLeft, AlignRight, ArrowDownToLine, ArrowRight, ArrowUpToLine, Check, Circle, Copy, Diamond, Droplet, Ellipsis, GripVertical, ImageIcon, Layers, Lock, Minus, Palette, Pencil, Square, Trash2, Type, Unlock, X,} from "lucide-react"
import {
...
function FloatingProperties ({
   ...
   const handleDragStart = (
        ...
        // Capture pointer movement on the handle so draggging continues even if the pointer leaves the button.
        e.preventDefault()
        e.stopPropagation()
               ...
               {!isImage && (
                  ...
                  <Popover>
                       ...
                       <PopoverContent 
                            ...
                            className=" z-9999 w-55 rounded-xl border border-slate-200 p-2.5 shadow-xl"
                            >
                              <PropertyLabel>
               ...
               {isShape && (
                   <Popover>
                        ...
                        >
                           ...
                           <div className="mt-2 grid grid-rows-6 gap-1.5">
                                {COLORS.map((color) => (
                    ...
                    <Popover>
                          ...
                          >
                             <div className="flex gap-0.5">
                                 <MiniButton 
                                     active={ !selectedElement.textAlign || selectedElement.textAlign === "left"}
                                     onClick= {() => 
               ...
               {(isLinear || isFreeDraw) && (
                  <Popover>
                     ...
                     <PopoverContent 
                          ...
                          align="center"
                          sideOffset={8}
                          className="z-9999 w-42.5 rounded-xl p-2 shadow-xl"
                     >
                        <PropertyLabel>
                            Stroke width
                        </PropertyLabel> 
                                 ...
                                 (width) => (
                                     <button 
                                           ...
                                           className={` flex h-8 items-center justify-center rounded-lg border 
                                                    ...
                                                    `}
                        >
                            <span  className="w-7 rounded-full bg-slate-700"
                                   style={{height: width}}
                            />
                                  </button>
                                 )
                ...
                <ToolbarButton
                      ...
                      onClick={onLock}
                >
                   {selectedElement.locked ? ( <Unlock size={18} /> ) 
                          : ( <Lock size={18} />
                    )}
                </ToolbarButton>
                ...
                >
                    ...
                    <PopoverContent
                         ...
                         className="z-9999 w-70 overflow-hidden rounded-2xl border border-slate-200 bg-white p-0 shadow-[0_18px_50px_rgba(15,23,42,0,18)]"
                    >
                        {/* =================================== */}
                        {/* HEADER */}
                        {/* =================================== */}
        ...
        return (
            <>
              ...
              <select
                  ...
                  className="mt-1.5 h-8 w-full roundef-lg border border-slate-200 bg-white px-2 text-xs outline-none focus:border-blue-400"
              >
                  <option value={1}>
                      1 px - Thin
                  </option>
      ...
      return (
         <button
             ...
             className={` flex h-9 w-9 items-center justify-center rounded-lg transition-all duration-150
                 ${danger?'text-red-500 hover:bg-red-50 hover:text-red-600' : active?
                'bg-slate-100 text-slate-900' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                }
            `}
         >
             {children}
    ...
    function QuickAction ({
      ...
      return (
        <button 
           type="button"
           onClick={onClick}
           className="flex h-10 items-center justify-center gap-1.5 rounded-lg border border-slate-200 px-2 text-[10px] font-medium text-slate-600
     ...
     onClick?: () => void 
      ...
      return (
        <button
            type="button"
            onClick={onClick}
            className="relative flex h-7 w-7 items-center justify-center rounded-full border border-slate-200 transition
             hover:scale-110
            "
            style={{
        ...
        >
            <div 
               className={` w-8 border-t-2 border-slate-600
                         ${styleType === "solid" ? "border-solid"
                         : styleType === "dashed" ? "border-dashed"
                         : "border-dotted"
                     }
                `}
            />
    ...
    function ToolbarDivider() {
        return (
            <div 
               className="mx-0.5 h-6 w-px bg-slate-200"
            />
        )
    }
    // ==============================================
